...
import useGetWorkspaceMembers from "../hooks/api/useGetWorkspaceMembers";
import { changeWorkspaceMemberRoleApi } from "../apis";
...
const AllMembers = () => {
  ...
  const { mutate, isPending: isLoading } = useMutation({
    mutationFn: changeWorkspaceMemberRoleApi,
  });
                  ...
                  <PopoverContent className="p-0" align="end">
                    <Command>
                      {/* <CommandInput
                        ...
                        disabled={isLoading}
                        className="disabled:pointer-events-none boarder-none"
                      /> */}
                      <CommandList>
                        {isLoading ? (
