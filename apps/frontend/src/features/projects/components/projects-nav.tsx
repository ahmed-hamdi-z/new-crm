...
import useGetProjectsInWorkspace from "../hooks/api/useGetProjectsInWorkspace";
        ...
        <SidebarGroupLabel className="w-full justify-between pr-0">
          ...
          <PermissionsGuard requiredPermission={Permissions.CREATE_PROJECT}>
            <button
              onClick={onOpen}
              type="button"
              className="flex size-5 items-center justify-center rounded-full border mr-1"
            >
              ...
              return (
                <SidebarMenuItem key={item._id}>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent
                      className="w-48 rounded-lg shadow-lg bg-white"
