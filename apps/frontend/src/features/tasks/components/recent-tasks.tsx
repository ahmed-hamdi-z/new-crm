...
import { getAvatarColor, getAvatarFallbackText, transformStatusEnum } from "@/config/helpers";
          ...
          return (
            ...
            >
              ...
              <div className="text-sm font-medium ">
                <Badge
                  variant={TaskStatusEnum[task.status] as "default" | "destructive" | "outline" | "secondary"}
              ...
              <div className="text-sm ml-2">
                <Badge
                  variant={TaskPriorityEnum[task.priority] as "default" | "destructive" | "outline" | "secondary"}
                  className="flex w-auto p-1 px-2 gap-1 font-medium shadow-sm uppercase border-0"
                >
